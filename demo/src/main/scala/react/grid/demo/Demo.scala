...
/*
  ...
  val component = ScalaComponent.builder[Props]("TableStaticDemo")
...
object Demo {
  ...
  val tableD = (s: Size) =>
    TableDynamicDemo(TableDynamicDemo.Props(true, "index", s)).vdomElement

  val component = ScalaComponent.builder[Unit]("Demo")
    .stateless
    .render_P { _ =>
      <.div(
