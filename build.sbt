...
// sbt-release-early
inThisBuild(List(
  homepage                := Some(url("https://github.com/rpiaggio/scalajs-ag-grid")),
  ...
  scmInfo := Some(ScmInfo(url("https://github.com/rpiaggio/scalajs-ag-grid"), "scm:git:git@github.com:rpiaggio/scalajs-ag-grid.git")),
  ...
  project.in(file("facade"))
    ...
    .settings(
      ...
      libraryDependencies    ++= Seq(
        ...
        "io.github.cquiroz.react"           %%% "test"       % "0.2.5" % Test,
...
lazy val commonSettings = Seq(
  ...
  description             := "scala.js facade for ag-grid",
  homepage                := Some(url("https://github.com/rpiaggio/scalajs-ag-grid")),
  licenses                := Seq("BSD 3-Clause License" -> url("https://opensource.org/licenses/BSD-3-Clause")),
